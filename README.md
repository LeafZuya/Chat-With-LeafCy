...
const RESPONSES = {
  ...
  "Apa Itu LeafCy?": ["LeafCy(Aku),Adalah Suatu Program AI Yang Bermodalkan Coding JS Dan Local Storage...Aku Pertama Kali Dibuat Dengan Model ICE-1.0 Oleh LeafZuya(Daffa),Yang Baru Berusia 14 tahun..."],
